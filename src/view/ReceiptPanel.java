...
public class ReceiptPanel extends javax.swing.JPanel {
    ...
    /**
     * Wires up the Client ID and Animal ID text fields so that typing an ID
     * automatically looks up and shows the matching data from the Client
     * and Animal tables (Name, Type, etc.), connecting all the related
     * tables together.
     */
    ...
    private void refreshCartTable() {
        ...
        for (int i = 0; i < cartItems.size(); i++) {
            ...
            data[i][4] = item.medicine.getName() + " x" + item.qty;
            data[i][5] = item.qty;
